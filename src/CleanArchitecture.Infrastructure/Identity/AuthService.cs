    ...
    ILogger<AuthService> logger) : IAuthService
{
    ...
    public async Task<AuthResult> RefreshTokenAsync(string refreshToken, CancellationToken cancellationToken = default)
    {
        ...
        {
            // Reuse of a rotated token — likely theft. Revoke the whole descendant chain.
        ...
        // Rotate: revoke the presented token and issue a new one linked to it.
    ...
    /// <summary>Deletes revoked/expired tokens older than the retention window (single SQL statement).</summary>
